...
import { LogOut, Edit3, ShoppingBag } from 'lucide-react'; // Edit3 for edit profile, ShoppingBag for order history (future)
          ...
          <Card className="shadow-lg">
            <CardHeader className="items-center text-center">
              <Avatar className="w-24 h-24 mb-4 border-4 border-primary">
                 <AvatarImage src={`https://placehold.co/100x100.png?text=${user.name.charAt(0)}`} alt={user.name} data-ai-hint="profile avatar large" />
